...
- Direct attribution for the audited wrapper/PDFium boundary is recorded in `licenses/pypdfium2-5.13.0/NOTICE.md`. The 19 verbatim upstream license/notice payloads from the accepted wheel are preserved as three direct license files plus deterministic `licenses/pypdfium2-5.13.0/upstream/BUILD_LICENSES.tar.gz`; their logical file hashes are pinned by `licenses/pypdfium2-5.13.0/UPSTREAM_LICENSES.sha256`, and the archive is pinned by `licenses/pypdfium2-5.13.0/UPSTREAM_BUILD_LICENSES.sha256`. The original wheel metadata is preserved and integrity-pinned by `licenses/pypdfium2-5.13.0/UPSTREAM_METADATA.sha256`.
