...
- Direct attribution for the audited wrapper/PDFium boundary is recorded in `licenses/pypdfium2-5.13.0/NOTICE.md`. The 19 verbatim upstream license/notice files from the accepted wheel are preserved under `licenses/pypdfium2-5.13.0/upstream/` and integrity-pinned by `licenses/pypdfium2-5.13.0/UPSTREAM_LICENSES.sha256`. The original wheel metadata is preserved and integrity-pinned by `licenses/pypdfium2-5.13.0/UPSTREAM_METADATA.sha256`.
